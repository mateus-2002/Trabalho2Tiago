...
import { ItemController } from '../viewModels/itemViewModels';
import { Item } from '../models/item';

const ItensView = () => {
  const [controller] = useState(() => new ItemController());
  ...
  const handleAddItem = () => {
    if (controller.addItem(inputText)) {
      loadItems();
      closeModal();
    }
  };
  ...
  const handleUpdateItem = () => {
    if (editingItem && controller.updateItem(editingItem.id, inputText)) {
      loadItems();
      closeModal();
    }
  };
